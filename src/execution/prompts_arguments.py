...
def add_least_to_most():
    return  (" Assign the parameters of the function with arguments." 
            ...
            "- 1.: Assign all or only the required parameters of the functions with the help of the output of the previou functions."
            "Decide utilizing you knowledge which parameters are assigned. Try to assign the parameters by using most current output."
            "If this is not possible, jump to the next output.\n"
            "- 2.: Assign the parameters which haven't been assigned yet with arguments extracted from the workflow description.\n"
            "- 3.: If assignation is not possible for the required parameters, throw an Assignation error\n"
...
def add_output_pattern():
     return (" Only provide the output in the output pattern. Dont return any explanation or reasoning."
             ...
             " Never return ```json\n{\"parameter\": \"value\"}\n```\n"
             " If you were unsuccessfull assigning required parameters, return the output:"
             " 'Assignation error' \n")
